...
class RunPolicyNode(object):
    ...
    def __init__(self):
        ...
        self.model = keras.modesl.load_model(model_file)
    ...
    def compute_joints_position(self, msg, joint1, joint3):
        ...
        inputs = np.array([[msg.pose.position.x, msg.pose.position.y, msg.pose.position.z, joint1, joint3]])
        predicted_targets = self.model.predict(inputs)
